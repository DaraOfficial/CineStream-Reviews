import { getPopularMovies, searchMedia, getNowPlayingMovies, getPopularTVShows, getMediaImages, TMDBError, getTrending, getOnTheAirTVShows } from '@/lib/tmdb';
...
export default async function Home({ searchParams }: { searchParams: Promise<{ q?: string }> }) {
  ...
  try {
    if (query) {
      ...
      const [popMoviesData, nowPlayingData, popTVData, trendingTodayData, trendingWeekData] = await Promise.all([
        getPopularMovies(),
        getNowPlayingMovies(),
        getPopularTVShows(),
        getTrending('day'),
        ...
        <div className={`container mx-auto px-4 md:px-8 max-w-[1400px] relative z-20 ${!query ? 'mt-8 md:mt-12' : 'pt-24 mt-8 md:mt-12'}`}>
          {errorMsg ? (
            ...
            <div className="space-y-4 mb-24">
              ...
              <MediaRow title="New Movies" items={nowPlaying} />
